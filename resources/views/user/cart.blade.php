                                        ...
                                        <tr class="table_row cart_items" id="cart-item{{$cart->id}}">
                                            <td style="width: 18%">
                                                <div class="how-itemcart1">
                                                    <img src="{{ $cart->details->product->thumbs[0]->url }}" alt="IMG">
                                                </div>
                                            </td>
                                            <td style="width: 18%">
                        ...
                        <div class="col-12 border-top p-3">
                            <div class="row">
                                <div class=" col-12 mb-3">
                                    <select class="form-control form-select-sm" id="payment" aria-label=".form-select-sm"
                                        style="background-color: rgb(147, 244, 211)" name = "payment">
                                ...
                                <div class=" col-12 mb-3">
                                    <select class="form-control form-select-sm" id="city" aria-label=".form-select-sm">
                                        <option value="" selected>Chọn tỉnh thành</option>
                                    </select>
                                </div>
                                <div class="col-12 mb-3">
                                    <select class="form-control form-select-sm" id="district" aria-label=".form-select-sm">
